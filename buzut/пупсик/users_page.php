...
<div class="Hide-background"></div>
    ...
    <main>
        <div class="users">
            ...
            if((isset($messageList[0]))){
                ...
                foreach($messageList as $user){
                    ...
                    if(!$flag){
                        echo "<a class='users_user' href='users_page.php?user_id=$res[id]'><p>$res[login]</p><p>открыть чат</p></a>";
                        $arr[] = $res['login'];
                    }
                }
            }
        ...
        foreach($userList as $user){
            echo "<a class='users_user' href='users_page.php?user_id=$user[id]'><p>$user[login]</p><p>открыть чат</p></a>";
        }
        ?>
        </div>
        <div class="message2">
